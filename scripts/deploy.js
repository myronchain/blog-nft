...
const network_configs = {
  mumbai: {
    ...
    metadata_uri: "https://market-api-dev.delysium.com/contracts/delysium_market_v2_assets/",
  },
  polygon : {
    USDCAddress: "0x2791bca1f2de4661ed88a30c99a7a9449aa84174",
    metadata_uri: "https://market-api.delysium.com/contracts/delysium_market_v2_assets/",
  },
}
let config;
...
async function main() {
  ...
  const assets = await hre.ethers.getContractFactory("DelysiumAssets");
  let upgradedAssets = await upgrades.deployProxy(assets,
      ["Delysium Assets", "DA", config.metadata_uri],
  ...
  const Stores = await ethers.getContractFactory("DelysiumStore");
